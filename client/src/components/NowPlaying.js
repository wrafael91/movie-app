...
export default function NowPlaying() {
  ...
  const handleClick = () => {
    const movieUrl1 = `https://api.themoviedb.org/3/movie/now_playing?api_key=${
      apikeys.REACT_APP_API_KEY
  ...
  return (
    <div className="image-container">
      {movies[0] && (
        <MainImage
          image={`http://image.tmdb.org/t/p/w1280${movies[0].backdrop_path}`}
